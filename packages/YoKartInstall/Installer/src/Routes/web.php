<?php
Route::group(['prefix' => 'install','as' => 'Installer::','namespace' => 'YoKartInstall\Installer\Controllers','middleware' => ['web', 'install']], function() {
    Route::get('/', [
        'as' => 'welcome',
    ...
    Route::get('database/{dummyDataStatus}', [
        'as' => 'database',
...
Route::group(['prefix' => 'update','as' => 'LaravelUpdater::','namespace' => 'YoKartInstall\Installer\Controllers','middleware' => 'web'],function() {
