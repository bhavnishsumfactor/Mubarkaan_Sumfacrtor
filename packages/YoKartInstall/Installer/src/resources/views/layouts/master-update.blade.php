...
<html>
    <head>
        ...
        <title>@if (trim($__env->yieldContent('template_title')))@yield('template_title') | @endif {{ trans('Laravel Updater') }}</title>
        <link rel="icon" type="image/png" href="{{ Installer::asset('installer/img/favicon/favicon-16x16.png') }}" sizes="16x16"/>
