...
<html>
    <head>
        ...
        <title>@if (trim($__env->yieldContent('template_title')))@yield('template_title') | @endif {{ trans('YoKart Installer') }}</title>
    ...
    <body>
        <div class="master">
            <div class="box">
                <div class="header">
                    <div class="header__logo"><a href="#"><img src="{{ asset('installer/img/logo.png') }}" alt=""></a></div>
