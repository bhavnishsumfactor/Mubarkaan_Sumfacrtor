  ...
  computed: {
    isComplete: function isComplete() {
      if (this.mode == "email") {
        ...
        return this.formData.user_phone;
      }
    }
  },
...
var render = function() {
  ...
  return _c(
    ...
    [
        ...
        "button",
        {
          ...
          on: {
            click: function($event) {
              return _vm.$bvModal.hide("loginModal")
            }
          }
        },
        [_vm._v("\n    ×\n  ")]
      ...
      _vm._v(" "),
      _c("div", { staticClass: "login-page popup" }, [
          ...
          _c(
            ...
            [
                        ...
                        [
                          _vm.passwordType === "checkbox"
                            ? _c("input", {
                                ...
                                staticClass:
                                  "form-control form-floating__field",
                                attrs: {
                                  id: "password",
                                  name: "password",
              ...
              _c("div", { staticClass: "row" }, [
                ...
                _c(
                  "div",
                  { staticClass: "col col-12 col-lg-6 text-lg-right" },
                  [
                    _c("div", { staticClass: "form-group" }, [
                            ...
                            _c(
                              ...
                              [
                                ...
                                _vm.mode == "phone"
                                  ? _c("span", [
                                      _vm._v(
                                        _vm._s(_vm.$t("LNK_USE_EMAIL_INSTEAD"))
                                      )
                                    ])
                                  : _vm._e(),
                                _vm._v(" "),
                                _vm.mode == "email"
                                  ? _c("span", [
                                      _vm._v(
                                        _vm._s(_vm.$t("LNK_USE_PHONE_INSTEAD"))
                                      )
                                    ])
                                  : _vm._e()
                              ]
