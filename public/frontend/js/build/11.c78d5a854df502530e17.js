...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    selectedFormData: function selectedFormData(records) {
      ...
      this.userData.redirect = 0;
      this.margeChanges();
    },
    placeOrderOnsite: function placeOrderOnsite() {
      this.userData.redirect = 1;
      this.paymentFromData = this.userData;
      this.margeChanges();
    },
    selectedData: function selectedData(records) {
      ...
      records.billing_address = this.userData.billing_address;
  ...
  mounted: function mounted() {
    //console.log("Test"+JSON.stringify(this.paymentRecords))
    if (this.paymentRecords.creditCard !== null) {
      this.userData.selectedTab = "credit";
    } else if (this.paymentRecords.paypal || this.paymentRecords.paypalExpress) {
      this.userData.selectedTab = "paypal";
    } else if (this.paymentRecords.cashFree) {
      this.userData.selectedTab = "cashFree";
    } else if (this.paymentRecords.stripe) {
      this.userData.selectedTab = "stripe";
    } else {
      this.userData.selectedTab = "paycash";
    }
  }
});
              ...
              _c(
                ...
                [
                  _vm.paymentRecords.creditCard
                    ...
                    : _vm._e(),
                  _vm._v(" "),
                  _vm.paymentRecords.paypal || _vm.paymentRecords.paypalExpress
                    ? _c("li", { staticClass: "nav-item" }, [
                        _c(
                          "a",
                          {
              ...
              _c("div", { staticClass: "tab-content YK-PaymentMethod" }, [
                ...
                _vm.paymentRecords.paypal || _vm.paymentRecords.paypalExpress
                  ? _c(
                      ...
                      [
                        _vm.paymentRecords.paypalExpress
