...
/* harmony default export */ __webpack_exports__["default"] = ({
  props: ["products", "listingGridView", "aspectRatio", "perPageRecords", "firstItem", "lastItem", "paginationData", "perPage"],
  components: {
        ...
        [
          _vm.products.data.length > 0
            ? _c(
                ...
                [
                  _vm._v("\n      " + _vm._s(_vm.paginationData) + "\n      "),
                  _c("pagination", {
                    attrs: { pagination: _vm.paginationData },
