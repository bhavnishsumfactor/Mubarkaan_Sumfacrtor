...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  watch: {
    cartData: function cartData() {
      ...
      if (this.couponUpdate == true && this.cartInfo.couponName != "" && this.cartInfo.couponType == 1) {
        this.couponName = this.cartInfo.couponName;
        this.couponApplied(this.cartInfo.cartPage);
      }
    }
  },
  methods: {
