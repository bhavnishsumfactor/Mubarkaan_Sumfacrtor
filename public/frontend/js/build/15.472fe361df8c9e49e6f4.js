...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getWhiteClass: function getWhiteClass(selectedoption) {
      ...
      return whiteClass; // return selectedoptionwhiteClass
    },
        ...
        _c("div", { staticClass: "product-quantity" }, [
          ...
          _c("div", { staticClass: "quantity quantity-detail YK-quantity" }, [
            ...
            _c("input", {
              ...
              attrs: {
                max:
                  _vm.product.prod_max_order_qty < _vm.product.totalstock
                    ? _vm.product.prod_max_order_qty
                    : _vm.product.totalstock,
                min:
                  _vm.product.prod_min_order_qty > 0
                    ? _vm.product.prod_min_order_qty
                    : 1,
                      ...
                      ? _c(
                          ...
                          [
                            _c(
                              ...
                              _vm._l(_vm.allVarients, function(
                                varient,
                                ovindex
                              ) {
                                return _c(
