    ...
    _c(
      ...
      [
        ...
        _c("VueSimpleRangeSlider", {
          ...
          model: {
            value: _vm.useData.range,
            callback: function($$v) {
              _vm.$set(_vm.useData, "range", $$v)
            },
            expression: "useData.range"
          }
        }),
        _vm._v(" "),
        _c("div", { staticClass: "sidebar-widget" }, [
                      ...
                      return _c("li", { key: index }, [
                        _c("label", { staticClass: "checkbox" }, [
                          _c("input", {
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.useData.condistion,
                                expression: "useData.condistion"
                              }
                            ],
                            attrs: {
                              "data-field-caption": "",
                            ...
                            domProps: {
                              value: condition,
                              checked: Array.isArray(_vm.useData.condistion)
                                ? _vm._i(_vm.useData.condistion, condition) > -1
                                : _vm.useData.condistion
                            },
                            on: {
                              change: function($event) {
                                var $$a = _vm.useData.condistion,
                                  $$el = $event.target,
                                ...
                                if (Array.isArray($$a)) {
                                  ...
                                  _vm.$set(_vm.useData, "condistion", $$c)
                                }
                              }
                            }
                          }),
