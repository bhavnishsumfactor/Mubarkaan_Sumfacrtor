                        ...
                        _c("input", {
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.userData[option.name].options,
                              expression: "userData[option.name].options"
                            }
                          ],
                          attrs: {
                            "data-field-caption": "",
                          ...
                          domProps: {
                            ...
                            checked: Array.isArray(
                              _vm.userData[option.name].options
                            )
                              ? _vm._i(
                                  _vm.userData[option.name].options,
                                  op.opn_id
                          ...
                          on: {
                            change: function($event) {
                              var $$a = _vm.userData[option.name].options,
                                $$el = $event.target,
