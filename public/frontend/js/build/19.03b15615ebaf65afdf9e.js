...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  props: ["product", "rating", "sharethisNetworks", "pageUrl", "sizeExist", "sizeChartImage", "allVarients", "selectedVarient", "otherVarients", "shipping"],
  computed: {
    min: function min() {
  ...
  methods: {
    ...
    shipInfoByStateCode: function shipInfoByStateCode(stateCode) {
      ...
      this.$axios.post(baseUrl + "/product/validate-shipping", formData).then(function (response) {
        if (response.data.status == false) {
          _this4.isShipNotAvail = true;
          _this4.isShipAvail = false;
          _this4.loading = false;
        } else {
          _this4.isShipAvail = true;
          _this4.isShipNotAvail = false;
          _this4.expDelDate = response.data.data.expected_del_date;
          _this4.delBy = response.data.data.name;
          _this4.loading = false;
        }
      });
    }
