...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getVarient: function getVarient(varientCode) {
      ...
      setTimeout(function () {
        _this3.isFav = _this3.checkFavorite(_this3.product);
      }, 1000);
    },
    ...
    updateOptions: function updateOptions() {
      ...
      Object.keys(this.options).forEach(function (key) {
        _this4.selectedOption[key] = [];
        Object.keys(_this4.options[key].poption_id).forEach(function (op) {
          if (_this4.$inArray(_this4.options[key].poption_id[op], options)) {
            _this4.selectedOption[key] = _this4.options[key].poption_id[op];
          }
        });
      });
    }
    ...
    [
      ...
      _c("div", { staticClass: "price-wrapper" }, [
        _c("div", { staticClass: "product__price" }, [
          ...
          _vm._v(
            "\n      " +
              _vm._s(parseFloat(_vm.product.price)) +
              "\n      " +
              _vm._s(parseFloat(_vm.product.finalprice)) +
              "\n      "
          ),
