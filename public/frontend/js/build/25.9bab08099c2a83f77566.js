...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  props: ["specifications", "buytogetherproducts", "relatedproducts", "record_id", "product", "recentViewProducts", "productImages", "allVarients", "rating", "sizeExist", "published", "shipping", "page", "productDummyImage", "productAspectRatio", "sharethisNetworks", "page_url", "selectedVarient", "otherVarients"],
  data: function data() {
    var _ref;
    ...
    return _ref = {
      ...
      v_pageUrl: this.pageUrl,
      v_selectedVarient: this.selectedVarient,
      v_otherVarients: this.otherVarients
    }, _defineProperty(_ref, "v_otherVarients", this.otherVarients), _defineProperty(_ref, "v_productAspectRatio", this.productAspectRatio), _ref;
  },
  methods: {
    getVarientData: function getVarientData(varientCode) {
      var _this = this;

      // this.$inertia.visit(baseUrl + '/product/' + this.product.prod_id + '/' + varientCode, { only: ["product", "productImages", "allVarients", "rating", "sizeExist", "published", "shipping", "sharethisNetworks", "pageUrl", "selectedVarient", "otherVarients", "productDummyImage", "productAspectRatio"] });
      ...
      this.$axios.post(baseUrl + "/product/product-varient-price", formData).then(function (response) {
        ...
        _this.productImages = res.productImages;
        _this.allVarients = res.allVarients;
        _this.rating = res.rating;
        _this.sizeExist = res.sizeExist;
        _this.published = res.published;
        _this.shipping = res.shipping;
        _this.sharethisNetworks = res.sharethisNetworks;
        _this.pageUrl = res.pageUrl;
        _this.selectedVarient = res.selectedVarient;
        _this.otherVarients = res.otherVarients;
        _this.productDummyImage = res.productDummyImage;
        _this.productAspectRatio = res.productAspectRatio;
      });
    }
  }
});
                  ...
                  [
                    _c("add-to-cart-section", {
                      attrs: {
                        ...
                        pageUrl: _vm.page_url,
                        sizeExist: _vm.sizeExist,
                        allVarients: _vm.allVarients,
                        selectedVarient: _vm.selectedVarient,
                        otherVarients: _vm.otherVarients,
