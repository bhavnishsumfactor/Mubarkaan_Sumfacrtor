...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    var thisObj = this;
    $('.YK-addToCart').on('click', function (e) {
      var productId = $(this).data('prod-id');
      var variantCode = $(this).data('pov-code');
      thisObj.$addToCart(productId, variantCode, false);
    });
    $(document).ready(function () {
      $(document).find('.yk-productCollectionLayout1 .yk-container, .yk-categoryCollectionLayout1 .yk-container').each(function () {
    ...
    $(document).on('keyup', '.yk-newsletter input[type="email"], .yk-newsletterCollection3 input[type="email"], .yk-footer input[name="email"]', function (e) {
    ...
    _carousel.each(function () {
      var _this = $(this),
          ...
          _slidesToCustom = $(_this.data('custom'));
      ...
      _this.slick({
        ...
        prevArrow: function () {
          return $('[data-href="#' + _this.attr("id") + '"] .prev-arrow');
        }(),
        nextArrow: function () {
          return $('[data-href="#' + _this.attr("id") + '"] .next-arrow');
        }(),
        infinite: false,
        pauseOnHover: true,
        autoplay: false,
      ...
      _this.on('beforeChange', function (event, slick, currentSlide, nextSlide) {
        ...
        if (nextSlide > 0) {
          _slidesToCustom.addClass('is-played');
        } else {
          _slidesToCustom.removeClass('is-played');
        }
      });
