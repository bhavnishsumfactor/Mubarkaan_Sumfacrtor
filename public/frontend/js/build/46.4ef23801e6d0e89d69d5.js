...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _frontend_Partials_Subscribe__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @/frontend/Partials/Subscribe */ "./resources/js/frontend/Partials/Subscribe.vue");
var _this = undefined;
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: _defineProperty({
    SliderImages: function SliderImages() {
      return __webpack_require__("./resources/js/frontend/Themes lazy recursive ^\\.\\/.*\\/Product\\/SliderImages$")("./".concat(_this.currentTheme, "/Product/SliderImages"));
    }
  }, "SliderImages", function SliderImages() {
    return __webpack_require__("./resources/js/frontend/Themes lazy recursive ^\\.\\/.*\\/Product\\/Add$")("./".concat(_this.currentTheme, "/Product/Add"));
  }),
  props: ["specifications", "buytogetherproducts", "relatedproducts", "record_id", "product", "recentViewProducts", "productImages", "allVarients", "rating", "sizeExist", "published", "shipping", "page"],
  data: function data() {
    return {
      baseUrl: baseUrl,
      currentTheme: currentTheme
...
/***/ "./resources/js/frontend/Themes lazy recursive ^\\.\\/.*\\/Product\\/Add$":
/*!***********************************************************************************!*\
  !*** ./resources/js/frontend/Themes lazy ^\.\/.*\/Product\/Add$ namespace object ***!
  \***********************************************************************************/
...
webpackEmptyAsyncContext.id = "./resources/js/frontend/Themes lazy recursive ^\\.\\/.*\\/Product\\/Add$";
