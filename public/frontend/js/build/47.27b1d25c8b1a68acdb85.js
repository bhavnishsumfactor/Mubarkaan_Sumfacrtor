  ...
  methods: {
    ...
    getVarientData: function getVarientData(varientCode) {
      ...
      var formData = this.$serializeData({
        ...
        old_varient_id: this.product.pov_code
      });
  ...
  return _c(
    ...
    [
      ...
      _vm.videoLinks[0] != "null"
        ? _c("section", { staticClass: "section section--bg " }, [
            _c("div", { staticClass: "container" }, [
              ...
              _c(
                ...
                [
                  _c(
                    "vue-slick-carousel",
                    _vm._b(
                      { staticClass: "js-carousel  d-grid" },
                      "vue-slick-carousel",
      ...
      _vm.recentViewProducts.length > 0
        ? _c("section", { staticClass: "section section--slider bg-grayx" }, [
            _c("div", { staticClass: "container" }, [
              _c(
                "div",
                { staticClass: "section__header d-flex align-items-center" },
