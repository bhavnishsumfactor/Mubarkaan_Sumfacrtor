...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  props: ["specifications", "buytogetherproducts", "relatedproducts", "record_id", "product", "recentViewProducts", "productImages", "allVarients", "rating", "sizeExist", "sizeChartImage", "published", "shipping", "page", "productDummyImage", "productAspectRatio", "sharethisNetworks", "page_url", "selectedVarient", "otherVarients", "aspectRatio"],
  data: function data() {
    var _ref;
  ...
  methods: {
    hasAttributesInfo: function hasAttributesInfo() {
      ...
      if (this.product.pc_isbn != "" && this.product.pc_isbn.toLowerCase() != "null" || this.product.pc_hsn != "" && this.product.pc_hsn.toLowerCase() != "null" || this.product.pc_sac != "" && this.product.pc_sac.toLowerCase() != "null" || this.product.pc_upc != "" && this.product.pc_upc.toLowerCase() != "null") {
        status = true;
      }
                          ...
                          _vm.hasAttributesInfo() === true
                            ? _c("div", { staticClass: "cms" }, [
                                _c("table", { staticClass: "cms-table" }, [
                                  _c("tbody", [
                                    _vm.product.pc_isbn != "" &&
                                    _vm.product.pc_isbn.toLowerCase() != "null"
                                      ? _c("tr", [
                                          _c(
                                            "th",
                                            { attrs: { width: "40%" } },
                                    ...
                                    _vm._v(" "),
                                    _vm.product.pc_hsn != "" &&
                                    _vm.product.pc_hsn.toLowerCase() != "null"
                                      ? _c("tr", [
                                          _c(
                                            "th",
                                            { attrs: { width: "40%" } },
                                    ...
                                    _vm._v(" "),
                                    _vm.product.pc_sac != "" &&
                                    _vm.product.pc_sac.toLowerCase() != "null"
                                      ? _c("tr", [
                                          _c(
                                            "th",
                                            { attrs: { width: "40%" } },
                                    ...
                                    _vm._v(" "),
                                    _vm.product.pc_upc != "" &&
                                    _vm.product.pc_upc.toLowerCase() != "null"
                                      ? _c("tr", [
                                          _c(
                                            "th",
                                            { attrs: { width: "40%" } },
