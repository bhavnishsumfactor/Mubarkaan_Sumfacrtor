...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    isComplete: function isComplete() {
      if (this.mode === "email") {
        return this.formData.user_fname && this.formData.user_lname && this.formData.user_password && this.formData.user_password_confirmation && this.agreedToTerms && !Object.values(this.passwordValidate).includes(false) && this.validConfirmPassword === 1 && (this.formData.user_phone && this.checkIfComplete($("#user_phone_mask")) === true || this.formData.user_email && emailFormat.test(this.formData.user_email.trim()) === true);
      } else {
        return this.formData.user_fname && this.formData.user_lname && this.agreedToTerms && (this.formData.user_phone && this.checkIfComplete($("#user_phone_mask")) === true || this.formData.user_email && emailFormat.test(this.formData.user_email.trim()) === true);
      }
    }
  },
  methods: {
    signup: function signup() {
      ...
      submitData.append("mode", this.mode);
