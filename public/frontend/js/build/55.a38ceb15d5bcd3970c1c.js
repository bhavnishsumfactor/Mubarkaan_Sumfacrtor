...
/* WEBPACK VAR INJECTION */(function(toastr) {/* harmony import */ var vue_slick_carousel__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! vue-slick-carousel */ "./node_modules/vue-slick-carousel/dist/vue-slick-carousel.umd.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  props: ["blog", "blogProducts", "aspectRatio", "sharethisNetworks", "blogUrl", "logoImg", "postComments", "businessName", "relatedBlogs", "loggedin"],
  data: function data() {
    return {
      baseUrl: baseUrl,
      comment: "",
      errors: [],
      sliderSettings4Column: {
        slidesToShow: 6,
        slidesToScroll: 1,
        autoplay: false,
        arrows: true,
  ...
  mounted: function mounted() {
    this.sliderSettings4Column.draggable = this.blogProducts.length > 6 ? true : false;
    $('.box-main-js').slick({
      dots: false,
      infinite: false,
      speed: 400,
                ...
                _c(
                  ...
                  [
                    _c(
                      ...
                      _vm._l(_vm.blogProducts, function(product, rtIndex) {
                        return _c(
                          "div",
