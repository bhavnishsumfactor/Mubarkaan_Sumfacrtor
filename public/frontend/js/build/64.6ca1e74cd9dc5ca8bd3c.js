...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getVarient: function getVarient(varientCode) {
      ...
      setTimeout(function () {
        if (_this.checkFavorite(_this.product) == true) {
          _this.isFav = 1;
        } else {
          _this.isFav = 0;
        }
    ...
    updateFavorite: function updateFavorite() {
      ...
      this.$axios.post(baseUrl + "/product/favourite", formData).then(function (response) {
        ...
        _this2.product.ufp_pov_code = fav_code; // this.checkFavorite(this.product);
        // this.$forceUpdate();

        if (_this2.checkFavorite(_this2.product) == true) {
          _this2.isFav = 1;
        } else {
          _this2.isFav = 0;
        }
  ...
  mounted: function mounted() {
    if (this.checkFavorite(this.product) == true) {
      this.isFav = 1;
    } else {
      this.isFav = 0;
    }
