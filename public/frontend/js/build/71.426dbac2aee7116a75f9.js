                    ...
                    return _c("li", { key: optionKey }, [
                      _c("label", { staticClass: "checkbox" }, [
                        _c("input", {
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.userData.options.name,
                              expression: "userData.options.name"
                            }
                          ],
                          attrs: {
                            "data-field-caption": "",
                          ...
                          domProps: {
                            value: op.opn_id,
                            checked: Array.isArray(_vm.userData.options.name)
                              ? _vm._i(_vm.userData.options.name, op.opn_id) >
                                -1
                              : _vm.userData.options.name
                          },
                          on: {
                            change: function($event) {
                              var $$a = _vm.userData.options.name,
                                $$el = $event.target,
                              ...
                              if (Array.isArray($$a)) {
                                ...
                                _vm.$set(_vm.userData.options, "name", $$c)
                              }
                            }
                          }
                        }),
