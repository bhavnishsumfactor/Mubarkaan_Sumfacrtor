                        ...
                        _c("input", {
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.userData.options[option.name].name,
                              expression: "userData.options[option.name].name"
                            }
                          ],
                          attrs: {
                            "data-field-caption": "",
                          ...
                          domProps: {
                            ...
                            checked: Array.isArray(
                              _vm.userData.options[option.name].name
                            )
                              ? _vm._i(
                                  _vm.userData.options[option.name].name,
                                  op.opn_id
                          ...
                          on: {
                            change: function($event) {
                              var $$a = _vm.userData.options[option.name].name,
                                $$el = $event.target,
