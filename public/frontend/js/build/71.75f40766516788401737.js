                        ...
                        _c("input", {
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.userData.options[option.name].val,
                              expression: "userData.options[option.name].val"
                            }
                          ],
                          attrs: {
                            "data-field-caption": "",
                          ...
                          domProps: {
                            ...
                            checked: Array.isArray(
                              _vm.userData.options[option.name].val
                            )
                              ? _vm._i(
                                  _vm.userData.options[option.name].val,
                                  op.opn_id
                          ...
                          on: {
                            change: function($event) {
                              var $$a = _vm.userData.options[option.name].val,
                                $$el = $event.target,
