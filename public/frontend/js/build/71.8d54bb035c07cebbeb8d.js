...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    updateVarients: function updateVarients() {
      var _this = this;

      Object.keys(this.filters.options).forEach(function (key) {
        _this.userData.options[_this.filters.options[key].name] = [];
      });
    },
    updateVarientValues: function updateVarientValues() {
      this.$forceUpdate();
    }
  },
                        ...
                        _c("input", {
                          ...
                          on: {
                            change: [
                              ...
                              function($event) {
                                return _vm.updateVarientValues()
                              }
                            ]
                          }
                        }),
