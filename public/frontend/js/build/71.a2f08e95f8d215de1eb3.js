                    ...
                    return _c("li", { key: optionKey }, [
                      _c("label", { staticClass: "checkbox" }, [
                        _c("input", {
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.userData.options.val,
                              expression: "userData.options.val"
                            }
                          ],
                          attrs: {
                            "data-field-caption": "",
                          ...
                          domProps: {
                            value: op.opn_id,
                            checked: Array.isArray(_vm.userData.options.val)
                              ? _vm._i(_vm.userData.options.val, op.opn_id) > -1
                              : _vm.userData.options.val
                          },
                          on: {
                            change: function($event) {
                              var $$a = _vm.userData.options.val,
                                $$el = $event.target,
                              ...
                              if (Array.isArray($$a)) {
                                ...
                                _vm.$set(_vm.userData.options, "val", $$c)
                              }
                            }
                          }
                        }),
