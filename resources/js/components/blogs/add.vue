            ...
            <div class="container">
                <div class="subheader__main">
                    ...
                    <div class="subheader__breadcrumbs">
                        ...
                        <span class="subheader__breadcrumbs-separator"></span>
                        <span class="subheader__breadcrumbs-link">{{$t('LBL_ADD')}}</span>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <form class="form form--label-right" v-on:submit.prevent="validateRecord">
                            <div class="portlet__head">
                                <div class="portlet__head-label">
                                    <h3 class="portlet__head-title">{{ $t('LBL_BLOG_ARTICLE_SETUP')}}</h3>
                                </div>
                            </div>
                                    ...
                                    <div class="section__body">
                                                        ...
                                                        <div class="upload_cover">
                                                            <div class="img--container uploded__img" v-if="croppedImageView != ''"><img :src="croppedImageView" />
                                                                <div class="upload__action">
                                                                    <button type="button" @click="removeImage($event)" v-if="croppedImageView != ''">
                                                                        <svg>   
                                        ...
                                        <div class="row" v-if="products.length != 0">
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    <treeselect name="ptbp_prod_id" v-model="adminsData.ptbp_prod_id" :multiple="true" :value-consists-of="'LEAF_PRIORITY'" :defaultExpandLevel="Infinity" :clearable="false" :isDefaultExpanded="true" :options="products" :searchable="true" :open-on-click="true" :close-on-select="true" :placeholder="$t('PLH_SELECT_SOME')" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="portlet__foot">
                                        <div class="form__actions">
                                            <div class="row">
                                                ...
                                                <div class="col-auto">
                                                    <button type="button" class="btn btn-wide btn-brand gb-btn gb-btn-primary" @click="validateRecord()" :disabled='!isComplete || clicked==1 || !$canWrite("BLOGS")' v-bind:class="clicked==1 && 'gb-is-loading'">{{ $t('BTN_BLOG_CREATE')}}</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    export default {
        ...
        methods: {
            ...
            saveRecord: function(input) {
                ...
                this.$http.post(adminBaseUrl + '/blogs', formData)
            ...
            pageLoadData: function() {
                this.$http.post(adminBaseUrl + '/blogs/page-load-data')
                    .then((response) => {
