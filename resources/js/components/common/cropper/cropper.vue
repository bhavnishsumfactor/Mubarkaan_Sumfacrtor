  ...
  <div>
    <b-modal :id="modalElementId" ref="foo" centered>
      <template v-slot:modal-header>
        ...
        <button type="button" class="close" @click="closeCropperPopup"></button>
      </template>
      <div id="cropper-body">
      ...
      <template v-slot:modal-footer>
        ...
        <div class="form-group row mb-0" v-if="displayBackgroundOption == '1'">
          <div class="col-lg-12">
            <div class="checkbox-inline">
              <label class="checkbox">
                <input
                  value="1"
                  type="checkbox"
                  @click="updateAddBackgroundSetting($event)"
                  :checked="backgroundSetYes == '1'"
                />
                {{ $t("Add Background") }}
                <span></span>
              </label>
...
export default {
  ...
  updated: function () {
    this.displayBackgroundOption = this.backgroundOption;
    this.backgroundSetYes = this.backgroundYes;
  },
  methods: {
    updateAddBackgroundSetting: function (event) {
      this.addBackground = event.target.checked == true ? 1 : 0;
    },
    emitToParent(event) {
      this.$emit(
        "childToParent",
