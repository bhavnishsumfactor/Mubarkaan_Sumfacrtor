<template>
  <div>
              ...
              <div class="row justify-content-center">
                <div class="col-md-5">
                  ...
                  <div class="app__collections-head d-flex justify-content-between">
                    <h3>{{pageInfo.page_title}}</h3>
                    <div class="actions">
                      <a href="javascript:;"  @click.capture="confirmDelete()" class="btn btn-light btn-sm btn-icon">
                    ...
                    <div class="app__collections-wrapper scroll-y" style="max-height: 640px;">
                      <container
                        behaviour="copy"
                        group-name="1"
    ...
    ></tags-collection-form>
      <DeleteModel
          :recordId="pageId"
          :deletePopText="$t('LBL_DELETE_BRAND_TEXT')"
          @deleted="deleteRecord(pageId)"
        ></DeleteModel>
  </div>
</template>
  ...
  methods: {
   ...
   onDrop(collection, dropResult) {
    ...
    deleteRecord: function(recordId) {
      this.deleteCollRecordById(recordId, 0, 'content-pages');
    },
    
    
  },
  mounted: function() {
    this.refreshedListing();
  }
};
</script>
