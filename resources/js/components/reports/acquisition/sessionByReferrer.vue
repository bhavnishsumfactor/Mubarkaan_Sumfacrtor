<template>
    <div>
        <div class="datatable datatable--default datatable--brand datatable--loaded" id="sessionByReferrer" v-if="records.length > 0">
            <table class="datatable__table">
                <thead class="datatable__head datatable__head-fixed">
                    <tr class="datatable__row">
                        <th class="datatable__cell datatable__cell--sort"><span>{{ $t('LBL_REFERRER_SOURCE') }}</span></th>
                        <th class="datatable__cell datatable__cell--sort"><span>{{ $t('LBL_REFERRER_NAME') }}</span></th>
                ...
                <tbody class="datatable__body">
                    ...
                    <tr class="datatable__row" v-for = "(item, key) in records" :key="key">
                        <td class="datatable__cell"><span>{{ item.source }}</span></td>
                        <td class="datatable__cell"><span>{{ item.name }}</span></td>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            printSessionByReferrer() {
                this.$htmlToPaper('sessionByReferrer');
            },
