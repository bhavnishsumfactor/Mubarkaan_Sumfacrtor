<template>
    <div>
        <div class="datatable datatable--default datatable--brand datatable--loaded" id="profitByProduct" v-if="records.length > 0">
            <table class="datatable__table">
                ...
                <tbody class="datatable__body">
                    <tr class="datatable__row datatable__row-highlighted " >
                        ...
                        <td class="datatable__cell"><span>{{  }}</span></td>
                        <td class="datatable__cell"><span>{{ symbol }}{{  Math.round(totalGrossProfit) }}</span></td>                        
                    </tr>
        ...
        methods: {
            ...
            getProfitData : function() {
                ...
                this.$http.post(adminBaseUrl + '/reports/get-profit-by-product-report', formData ).then((response) => {
                    ...
                    //this.records = response.data.data['totalProducts'];
            ...
            printProfitByProduct () {
                this.$htmlToPaper('profitByProduct');
            },
