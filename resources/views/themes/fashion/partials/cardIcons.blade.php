@php $cardType = strtolower(cleanString($cardType));@endphp 
@if($cardType == "visa")
    <svg class="svg payment-list__item" viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg" data-yk=""  role="yk-img" width="38" height="24" aria-labelledby="pi-visa">
    ...
    <svg class="svg payment-list__item" viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg" data-yk=""  role="yk-img" width="38" height="24" aria-labelledby="pi-master">
...
@elseif($cardType == "americanexpress" || $cardType == "american-express")
<svg class="payment-list__item" xmlns="http://www.w3.org/2000/svg" data-yk=""  role="yk-img"
...
@elseif($cardType == "dinersclub" || $cardType == "diners-club")                
