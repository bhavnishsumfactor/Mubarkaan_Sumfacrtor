<section class="section yk-cmsCollection1" data-gjs-draggable="div.js-body">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 col-lg-10 font-size-lg text-gray-500">                
                <div class="cms">
                    <h3 class="mb-10 text-center ">Shipping & Returns</h3>
                    <p>
                    ...
                    <h5 class="mt-9 mb-7 ">Shipping from USA</h5>
                    <p>
                    ...
                    <h6 class="mt-8 mb-5 ">International Shipping</h6>
                    <p>
                        Saw wherein fruitful good days image them, midst, waters upon, saw. Seas lights seasons. Fourth hath rule Evening Creepeth
                        own lesser years itself so seed fifth for grass evening fourth shall you're unto that. Had. Female replenish for yielding so saw all
                        one to yielding grass you'll air sea it, open waters subdue, hath.
                    ...
                    <h6 class="mt-8 mb-5 ">About International Shipping</h6>
                    <p>
                    ...
                    <h6 class="mt-8 mb-5 ">Shipping Options & Costs</h6>
                    <p>
                        ...
                        wherein above said you. <strong class="">Darkness said. Good had saying lesser</strong>.
                    </p>

                    <p>
                        <a href="#!" class=" text-decoration-underline">You can check it here</a>
                    </p>

                    <h6 class="mt-8 mb-5 ">How to Order</h6>
                    ...
                    <h5 class="mt-9 mb-7 ">Returns & Exchanges</h5>
                    <p>
                    ...
                    <h6 class="mt-8 mb-5 ">How to Exchange an Item</h6>
                    <ol>
                        <li>
                    ...
                    <div class="row mt-9">
                        <div class="col-12 col-md-6">
                            <a class="btn btn-lg btn-block btn-outline-dark yk-anchor" href="">
                                Have more Questions?
                            </a>
                        </div>
                        <div class="col-12 col-md-6">
