@if($updateListing == 0)
<div class="yk-blogLayout1-settings" data-comp="{{$cid}}">
        ...
        <div class="modal-dialog modal-dialog-centered" data-yk=""  role="yk-document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="alert alert-secondary" data-yk=""  role="yk-alert">
                        ...
                        <div class="alert-text">{{__("LBL_BLOG_ARTICLES_INSTRUCTION1")}}<br>
                           {{__("LBL_BLOG_ARTICLES_INSTRUCTION2")}} 
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-icon input-icon--left">
                            <input type="text" class="form-control yk-autocompleteblogLayout1" placeholder="{{__('PLH_SEARCH_BLOG_POSTS')}}..." name="blog_name" autocomplete="off">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-brand gb-btn gb-btn-primary yk-addBlogLayout1Widget">{{__('BTN_EMBED')}}</button>
                </div>
            </div>
        </div>
    </div>
