@if($updateListing == 0)
  <div class="modalContent yk-categoryCollection3-settings" data-comp="{{$cid}}">
      ...
      <div class="modal-dialog modal-lg modal-dialog-centered modal-lg" data-yk=""  role="yk-document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">{{__('LBL_WIDGETNAME_CATEGORYCOLLECTION3')}}</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            <div class="alert alert-secondary" data-yk=""  role="yk-alert">
              <div class="alert-icon"><i class="flaticon-questions-circular-button"></i></div>
              <div class="alert-text">{{__('LBL_CATEGORYCOLLECTION3_INSTRUCTIONS')}}</div>
            </div>
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-brand gb-btn gb-btn-primary yk-addCategoryCollection3Widget">{{__('BTN_EMBED')}}</button>
          </div>
        </div>
      </div>
    </div>
