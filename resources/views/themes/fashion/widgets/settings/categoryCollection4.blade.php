@if($updateListing == 0)
  <div class="modalContent yk-categoryCollection4-settings" data-comp="{{$cid}}">
      ...
      <div class="modal-dialog modal-lg modal-dialog-centered modal-lg" data-yk=""  role="yk-document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">{{__('LBL_WIDGETNAME_CATEGORYCOLLECTION4')}}</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            <div class="alert alert-secondary" data-yk=""  role="yk-alert">
              <div class="alert-icon"><i class="flaticon-questions-circular-button"></i></div>
              <div class="alert-text">{{__('LBL_CATEGORYCOLLECTION4_INSTRUCTIONS')}}</div>
            </div>
                ...
                <li class="list-group-item yk-slide yk-category" data-id="{{$item['value']}}" data-display-order="{{$recordIds[$item['value']]}}">
                  <div class="row align-items-center">
                    ...
                    <div class="col">
                        ...
                        <p class="img-disclaimer editor"><strong>{{ __('LBL_IMAGE_DISCLAIMER') }}: </strong> {{ __('LBL_IMAGE_RESTRICTIONS') }} 800x800 {{__("LBL_IN")}} 1:1 {{ __('LBL_ASPECT_RATIO') }}</p>
                    </div>
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-brand gb-btn gb-btn-primary yk-addCategoryCollection4Widget">{{__('BTN_EMBED')}}</button>
          </div>
        </div>
      </div>
    </div>
