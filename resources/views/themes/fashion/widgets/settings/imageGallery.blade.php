<div class="modalContent yk-imageGallery-settings" data-comp="{{$cid}}">
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-lg" data-yk=""  role="yk-document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">{{__('LBL_IMAGE_GALLERY')}}</h5>
              ...
              <li class="list-group-item yk-slide" data-id="{{$key}}">
                <div class="row align-items-center">
                  <div class="col">
                      ...
                      <p class="img-disclaimer editor"><strong>{{ __('LBL_IMAGE_DISCLAIMER') }}: </strong> {{ __('LBL_IMAGE_RESTRICTIONS') }} 600x600.</p>
                  </div>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-brand gb-btn gb-btn-primary yk-addImageGalleryWidget">{{__('BTN_EMBED')}}</button>
        </div>
      </div>
    </div>
  </div>
