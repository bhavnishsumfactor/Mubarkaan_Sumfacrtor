<div class="yk-image-settings" data-comp="{{$cid}}">
    ...
    <div class="modal-dialog modal-dialog-centered" data-yk=""  role="yk-document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">{{__('LBL_IMAGE')}}</h5>
        ...
        <div class="modal-body">
          <ul class="list-group">
            <li class="list-group-item yk-slide">
              <div class="row">
                <div class="col">
                    <img data-yk="" alt="" class="actualImage" src="{{$data['image_actual'] ?? ''}}" style="display:none;">
                ...
                <div class="col-auto YK-preview" @if(empty($data['image_cropped'])) style="display:none;" @endif>
                    <ul class="list-media">
                        <li class="media"><img data-yk="" alt="" class="croppedImage" src="{{$data['image_cropped'] ?? ''}}">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-brand gb-btn gb-btn-primary yk-addImageWidget">{{__('BTN_EMBED')}}</button>
        </div>
      </div>
    </div>
  </div>
