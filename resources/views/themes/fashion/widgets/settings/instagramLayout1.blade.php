<div class="yk-instagramLayout1-settings" data-comp="{{$cid}}">
<div class="modal fade" id="settingsModal" tabindex="-1" data-yk=""  role="yk-dialog" aria-labelledby="exampleModalLabel" style="display: none;" aria-hidden="true">
    ...
    <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">{{__('LBL_INSTAGRAM_LAYOUT1')}}</h5>
    ...
    <div class="modal-footer">
        <button type="button" class="btn btn-brand gb-btn gb-btn-primary yk-addInstagramLayout1Widget">{{__('BTN_EMBED')}}</button>
    </div>
    </div>
    </div>
    </div>
