<div class="yk-newsletterFullwidth-settings" data-comp="{{$cid}}">
    ...
    <div class="modal-dialog modal-dialog-centered" data-yk=""  role="yk-document">
      <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">{{__('LBL_NEWSLETTER_FULL_WIDTH_LAYOUT')}}</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
            <div class="form-group row">            
                    <label class="col-md-4 col-form-label" for="validationCustom01">{{__("LBL_TEXT1")}}</label>
                  <div class="col-md-8"> <input type="text" class="form-control" name="text1" value="{{$data['text1'] ?? __('LBL_SIGNUP_FOR_NEWSLETTER')}}" required>
                </div>
            </div>
            <div class="form-group row">            
                <label class="col-md-4 col-form-label" for="validationCustom01">{{__("LBL_TEXT2")}}</label>
                <div class="col-md-8"> <input type="text" class="form-control" name="text2" value="{{$data['text2'] ?? __('LBL_NEWSLETTER_DESCRIPTION')}}" required>
                </div>
            </div>
            <ul class="list-group">
              <li class="list-group-item yk-slide">
                <div class="row">
                  <div class="col">
                  ...
                  <div class="col-auto YK-preview" @if(empty($data['banner_cropped'])) style="display:none;" @endif>
                      <ul class="list-media">
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-brand gb-btn gb-btn-primary yk-addNewsletterFullwidthWidget">{{__('BTN_EMBED')}}</button>
        </div>
      </div>
    </div>
  </div>
