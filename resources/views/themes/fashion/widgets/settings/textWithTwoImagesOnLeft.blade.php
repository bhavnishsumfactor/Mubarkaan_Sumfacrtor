<div class="modalContent yk-textWithTwoImagesOnLeft-settings" data-comp="{{$cid}}">
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-lg" data-yk=""  role="yk-document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">{{__('LBL_TEXT_WITH_IMAGES_ON_LEFT')}}</h5>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-brand gb-btn gb-btn-primary yk-addTextWithTwoImagesOnLeftWidget">{{__('BTN_EMBED')}}</button>
        </div>
      </div>
    </div>
  </div>
