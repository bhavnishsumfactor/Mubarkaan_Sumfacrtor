<div class="yk-titleWithBackgroundImage-settings" data-comp="{{$cid}}">
    ...
    <div class="modal-dialog modal-dialog-centered" data-yk=""  role="yk-document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">{{__('LBL_TITLE_WITH_BACKGROUND_IMAGE')}}</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
          <div class="form-group row">
              <label class="col-md-4 col-form-label" for="validationCustom01">{{__('LBL_TEXT1')}}</label>
                <div class="col-md-8"><input type="text" class="form-control" name="text1" value="{{$data['text1'] ?? __('LBL_WE_BELIEVE_WE_MAKE_STYLISH')}}" required>
              </div>
          </div>
          <ul class="list-group">
      ...
      <div class="modal-footer">
          <button type="button" class="btn btn-brand gb-btn gb-btn-primary yk-addTitleWithBackgroundImageWidget">{{__('BTN_EMBED')}}</button>
      </div>
      </div>
    </div>
  </div>
